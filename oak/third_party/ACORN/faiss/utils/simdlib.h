...
#include "oak/third_party/ACORN/faiss/utils/simdlib_avx2.h"

#elif defined(__aarch64__)

#include "oak/third_party/ACORN/faiss/utils/simdlib_neon.h"

#else

// emulated = all operations are implemented as scalars
#include "oak/third_party/ACORN/faiss/utils/simdlib_emulated.h"
